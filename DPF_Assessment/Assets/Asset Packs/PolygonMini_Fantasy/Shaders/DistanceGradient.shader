...
Shader "SyntyStudios/DistanceGradient"
{
	Properties
	{
		ColorFront("Color Front", Color) = (0,1,0.7517242,0)
		ColorBack("Color Back", Color) = (0,1,0.7517242,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult40 = clamp( ( ( Offset + aseworldPos.z ) / Distance ) , 0 , 1 );
			float4 lerpResult11 = lerp( ColorBack , ColorFront , saturate( pow( clampResult40 , Falloff ) ));
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-424.9747,105.4285;Float;False;Property;Offset;Offset;2;0;Create;True;0;0;26.51;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-359.3628,379.4822;Float;False;Property;Distance;Distance;3;0;Create;True;0;0;5.53;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-337.2385,-283.9739;Float;False;Property;ColorBack;Color Back;1;0;Create;True;0;0,1,0.7517242,0;0,1,0.7517242,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-335.864,-108.367;Float;False;Property;ColorFront;Color Front;0;0;Create;True;0;0,1,0.7517242,0;0.8161765,0.06001299,0.06001299,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
