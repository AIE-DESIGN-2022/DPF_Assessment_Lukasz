...
Shader "SyntyStudios/LocalGradient"
{
	Properties
	{
		ColorTop("Color Top", Color) = (0,1,0.7517242,0)
		ColorBottom("Color Bottom", Color) = (0,1,0.7517242,0)
		Offset("Offset", Float) = 0
		Distance("Distance", Float) = 0
		Falloff("Falloff", Range( 0.001 , 1)) = 0.001
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult40 = clamp( ( ( Offset + asevertex3Pos.y ) / Distance ) , 0 , 1 );
			float4 lerpResult11 = lerp( ColorTop , ColorBottom , saturate( pow( clampResult40 , Falloff ) ));
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-424.9747,105.4285;Float;False;Property;Offset;Offset;2;0;Create;True;0;0;0.5303507;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-359.3628,379.4822;Float;False;Property;Distance;Distance;3;0;Create;True;0;0;4.62;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-83.40302,564.1992;Float;False;Property;Falloff;Falloff;4;0;Create;True;0;0.001;1;0.001;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;41;303.2426,338.4253;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2;-337.2385,-283.9739;Float;False;Property;ColorTop;Color Top;0;0;Create;True;0;0,1,0.7517242,0;0.7205882,0.4439783,0.190744,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-335.864,-108.367;Float;False;Property;ColorBottom;Color Bottom;1;0;Create;True;0;0,1,0.7517242,0;0.7205882,0.4439783,0.190744,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
