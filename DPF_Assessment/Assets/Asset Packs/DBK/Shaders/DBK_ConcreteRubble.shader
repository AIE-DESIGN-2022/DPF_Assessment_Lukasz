...
Shader "DBK/ConcreteRubble"
{
	Properties
	{
		MainTex1("Color Theme", 2D) = "white" {}
		ColorMap("Color Map", 2D) = "white" {}
		ConcreteBrightness("Concrete Brightness", Range( 0 , 0.1)) = 0
		[PerRendererData]Color("Color", Int) = 0
		PaintRange("Paint Range", Range( 0 , 1)) = 0
		PaintSmooth("Paint Smooth", Range( 0 , 0.1)) = 0
		MainNM("Main NM", 2D) = "bump" {}
		DamageNM("Damage NM", 2D) = "bump" {}
		DamageNMTiling("Damage NM Tiling", Range( 1 , 8)) = 1
		DamageScale("Damage Scale", Range( 0 , 1)) = 0
		DetailNM("Detail NM", 2D) = "bump" {}
		DetailNMTiling("Detail NM Tiling", Range( 1 , 8)) = 0
		DetailScale("Detail Scale", Range( 1 , 4)) = 0
		DirtContrast("Dirt Contrast", Range( 0 , 2)) = 0
		DirtRange("Dirt Range", Range( 0 , 1)) = 0
		[MaxGay]DirtSmooth("Dirt Smooth", Range( 0 , 1)) = 0
		EdgesAdd("Edges Add", Range( 0 , 0.25)) = 0
		MaskB("Mask B", 2D) = "white" {}
		MainTex("Mask A", 2D) = "white" {}
		DirtInsideMultiplier("Dirt Inside Multiplier", Range( 0 , 1)) = 0
		AODirt("AO Dirt", Range( 0 , 1)) = 0
		MainSmoothness("Main Smoothness", Range( 0 , 1)) = 0
		PaintSmoothness("Paint Smoothness", Range( 0 , 1)) = 0
		...
		Cutoff( "Mask Clip Value", Float ) = 0.5
	...
	SubShader
	{
		...
		uniform sampler2D MainNM;
		uniform float4 MainNMST;
		uniform float DetailScale;
		uniform sampler2D DetailNM;
		uniform float DetailNMTiling;
		uniform float DamageScale;
		uniform sampler2D DamageNM;
		uniform float DamageNMTiling;
		uniform sampler2D MainTex;
		uniform float4 MainTexST;
		uniform sampler2D ColorMap;
		uniform float4 ColorMapST;
		uniform sampler2D MaskB;
		uniform float ConcreteBrightness;
		uniform float AODirt;
		uniform sampler2D MainTex1;
		uniform int Color;
		uniform int CustomColor;
		uniform float PaintRange;
		uniform float PaintSmooth;
		uniform float DirtInsideMultiplier;
		uniform float DirtRange;
		uniform float DirtSmooth;
		uniform float DirtContrast;
		uniform float EdgesAdd;
		uniform float MainSmoothness;
		uniform float DirtSmoothness;
		uniform float PaintSmoothness;
		uniform float Cutoff = 0.5;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uvMainNM = i.uvtexcoord * MainNMST.xy + MainNMST.zw;
			float3 tex2DNode2 = UnpackNormal( tex2D( MainNM, uvMainNM ) );
			float2 tempcast0 = (DetailNMTiling).xx;
			float2 uvTexCoord18 = i.uvtexcoord * tempcast0;
			float2 tempcast1 = (DamageNMTiling).xx;
			float2 uvTexCoord11 = i.uvtexcoord * tempcast1;
			float2 uvMainTex = i.uvtexcoord * MainTexST.xy + MainTexST.zw;
			float4 tex2DNode75 = tex2D( MainTex, uvMainTex );
			float MaskABlue76 = tex2DNode75.b;
			float3 lerpResult10 = lerp( BlendNormals( tex2DNode2 , UnpackScaleNormal( tex2D( DetailNM, uvTexCoord18 ), DetailScale ) ) , BlendNormals( tex2DNode2 , UnpackScaleNormal( tex2D( DamageNM, uvTexCoord11 ), DamageScale ) ) , MaskABlue76);
			float3 Normals71 = lerpResult10;
			o.Normal = Normals71;
			float2 uvColorMap = i.uvtexcoord * ColorMapST.xy + ColorMapST.zw;
			float4 tex2DNode250 = tex2D( ColorMap, uvColorMap );
			float2 ConcreteUVTiling73 = uvTexCoord18;
			float4 tex2DNode85 = tex2D( MaskB, ConcreteUVTiling73 );
			float MaskBAlpha89 = tex2DNode85.a;
			float MaskARed84 = tex2DNode75.r;
			float3 desaturateInitialColor247 = ( ( ( tex2DNode250 * MaskBAlpha89 ) + ( ( 1.0 - MaskABlue76 ) * ConcreteBrightness ) ) * ( 1.0 - ( MaskARed84 * AODirt ) ) ).rgb;
			...
			half2 ColorsNumber = half2(0,-0.1);
			#ifdef USECUSTOMCOLORON
				float staticSwitch94 = (float)CustomColor;
			#else
				float staticSwitch94 = (float)Color;
			#endif
			float2 tempoutput960 = ( half2( 0.015625,0 ) * staticSwitch94 );
			float2 uvTexCoord98 = i.uvtexcoord * ColorsNumber + tempoutput960;
			float4 Color1UV3105 = tex2D( MainTex1, uvTexCoord98 );
			float MaskBBlue88 = tex2DNode85.b;
			float MaskBRed86 = tex2DNode85.r;
			float3 tempcast6 = (( 1.0 - MaskBRed86 )).xxx;
			float MaskBGreen87 = tex2DNode85.g;
			float VertexGreen112 = i.vertexColor.g;
			float3 tempcast7 = (( MaskBGreen87 * VertexGreen112 )).xxx;
			float PaintSelection123 = ( saturate( ( 1.0 - ( ( distance( tempcast6 , tempcast7 ) - PaintRange ) / max( PaintSmooth , 1E-05 ) ) ) ) * ( 1.0 - MaskABlue76 ) );
			float4 lerpResult37 = lerp( float4( desaturateVar247 , 0.0 ) , ( Color1UV3105 + ( MaskBBlue88 * Color1UV3105 ) ) , PaintSelection123);
			float2 appendResult103 = (float2(tempoutput960.x , 0.1));
			float2 uvTexCoord107 = i.uvtexcoord * ColorsNumber + appendResult103;
			float4 DirtColorUV3109 = tex2D( MainTex1, uvTexCoord107 );
			float VertexRed125 = i.vertexColor.r;
			float3 tempcast9 = (( VertexRed125 * MaskBAlpha89 )).xxx;
			float3 tempcast10 = (( ( 1.0 - MaskBRed86 ) + ( ( 1.0 - MaskARed84 ) * DirtInsideMultiplier ) )).xxx;
			float clampResult63 = clamp( ( saturate( ( 1.0 - ( ( distance( tempcast9 , tempcast10 ) - DirtRange ) / max( DirtSmooth , 1E-05 ) ) ) ) * DirtContrast ) , 0.0 , 1.0 );
			float DirtSelection136 = clampResult63;
			float4 lerpResult194 = lerp( lerpResult37 , ( DirtColorUV3109 * MaskBAlpha89 ) , DirtSelection136);
			float ColorAlpha259 = tex2DNode250.a;
			float4 Albedo223 = ( lerpResult194 + ( EdgesAdd * ColorAlpha259 ) );
			o.Albedo = Albedo223.rgb;
			float Smoothnes244 = ( ( MaskBAlpha89 * MainSmoothness * ( 1.0 - MaskARed84 ) * ( 1.0 - ( DirtSelection136 * DirtSmoothness ) ) ) + ( PaintSmoothness * PaintSelection123 ) );
			o.Smoothness = Smoothnes244;
			o.Alpha = 1;
			float MaskAAlpha78 = tex2DNode75.a;
			clip( MaskAAlpha78 - Cutoff );
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-2921.166,834.166;Inherit;False;Property;DetailNMTiling;Detail NM Tiling;11;0;Create;True;0;0;False;0;False;0;6;1;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;75;-2950.09,-350.1125;Inherit;True;Property;MainTex;Mask A;18;0;Create;False;0;0;False;0;False;-1;fb4470513e42fce4988b8a33454a2d23;3f36e0caf78aeca4f81e435486cde529;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;85;-1919.399,-331.5393;Inherit;True;Property;MaskB;Mask B;17;0;Create;True;0;0;False;0;False;-1;1787681c2c1799842ba3c182bb57a76f;5b71a3cf759201643b7d66aa9084dbd4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;86;-1549.717,-333.7606;Inherit;False;MaskBRed;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;93;-2897.202,-1102.97;Inherit;False;Property;Color;Color;3;1;[PerRendererData];Create;False;0;0;False;0;False;0;0;0;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode;129;-1333.761,1318.584;Inherit;False;86;MaskBRed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;198;-1238.084,1433.548;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;92;-2914.08,-949.0204;Inherit;False;Property;CustomColor;Custom Color;25;0;Create;True;0;0;False;0;False;0;1;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-1361.873,1557.477;Inherit;False;Property;DirtInsideMultiplier;Dirt Inside Multiplier;19;0;Create;True;0;0;False;0;False;0;0.1622185;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;89;-1543.469,-44.07379;Inherit;False;MaskBAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;94;-2694.08,-984.0204;Inherit;False;Property;UseCustomColor;Use Custom Color;24;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;130;-1339.726,1760.416;Inherit;False;89;MaskBAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;95;-2695.445,-1277.643;Half;False;Constant;NumberOfColors;NumberOfColors;19;0;Create;True;0;0;False;1;;False;0.015625,0;0.125,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;40;-1103.042,1879.537;Inherit;False;Property;DirtRange;Dirt Range;14;0;Create;True;0;0;False;0;False;0;0.6583209;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;87;-1554.47,-246.0881;Inherit;False;MaskBGreen;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;97;-2330.451,-1345.763;Half;False;Constant;ColorsNumber;ColorsNumber;19;1;[HideInInspector];Create;True;0;0;False;0;False;0,-0.1;0.125,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-1108.646,1950.517;Inherit;False;Property;DirtSmooth;Dirt Smooth;15;0;Create;True;0;0;False;1;MaxGay;False;0;0.7691464;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;99;-1892.992,-1152.964;Inherit;True;Property;MainTex1;Color Theme;0;0;Create;False;0;0;False;0;False;bf84d265e341525459ab1fd8a003c547;bf84d265e341525459ab1fd8a003c547;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.GetLocalVarNode;111;-2901.394,1293.983;Inherit;False;87;MaskBGreen;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;114;-2894.061,1504.102;Inherit;False;86;MaskBRed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-643.4355,1902.083;Inherit;False;Property;DirtContrast;Dirt Contrast;13;0;Create;True;0;0;False;0;False;0;0.9294118;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;172;542.4216,-1233.566;Inherit;False;Property;AODirt;AO Dirt;20;0;Create;True;0;0;False;0;False;0;0.2194365;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;117;-2645.65,1489.56;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;102;-1468.444,-1300.557;Inherit;True;Property;TextureSample2;Texture Sample 2;30;0;Create;True;0;0;False;0;False;-1;None;0b2ec52f502fe5943bc55689099e11b5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-2741.605,1744.239;Inherit;False;Property;PaintSmooth;Paint Smooth;5;0;Create;True;0;0;False;0;False;0;0.06668227;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;250;-539.0715,-1231.969;Inherit;True;Property;ColorMap;Color Map;1;0;Create;True;0;0;False;0;False;-1;89f871b5c2ed6704e9b783d5c11d09a8;89f871b5c2ed6704e9b783d5c11d09a8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-2741.436,1647.875;Inherit;False;Property;PaintRange;Paint Range;4;0;Create;True;0;0;False;0;False;0;0.64755;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;138;-525.9857,-914.3888;Inherit;False;89;MaskBAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;168;-455.5076,-600.5148;Inherit;False;Property;ConcreteBrightness;Concrete Brightness;2;0;Create;True;0;0;False;0;False;0;0.06670231;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;88;-1539.47,-141.0881;Inherit;False;MaskBBlue;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;108;-1449.86,-788.6917;Inherit;True;Property;TextureSample5;Texture Sample 5;32;0;Create;True;0;0;False;0;False;-1;None;0b2ec52f502fe5943bc55689099e11b5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;145;753.8755,-290.1053;Inherit;False;88;MaskBBlue;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;232;-791.0201,722.3155;Inherit;False;Property;DirtSmoothness;Dirt Smoothness;23;0;Create;True;0;0;False;0;False;0;1.076944;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-2913.929,505.2257;Inherit;False;Property;DamageNMTiling;Damage NM Tiling;8;0;Create;True;0;0;False;0;False;1;8;1;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-2586.196,994.4211;Inherit;False;Property;DetailScale;Detail Scale;12;0;Create;True;0;0;False;0;False;0;2.605882;1;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;202;1953.582,-496.9103;Inherit;False;89;MaskBAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-2634.162,666.2617;Inherit;False;Property;DamageScale;Damage Scale;9;0;Create;True;0;0;False;0;False;0;0.7267291;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-2307.802,221.5238;Inherit;True;Property;MainNM;Main NM;6;0;Create;True;0;0;False;0;False;-1;5f34cf4c7404a0c44b51bf8e72241005;e7e06dc793e3ae7449663a387c4f4933;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-2211.133,917.5221;Inherit;True;Property;DetailNM;Detail NM;10;0;Create;True;0;0;False;0;False;-1;5151c7b9c95404c4c9c83ccd6634c674;e2f2024fc17d02a4cae64316bfc62502;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;67;2214.181,-1130.429;Inherit;False;Property;EdgesAdd;Edges Add;16;0;Create;True;0;0;False;0;False;0;0.04346062;0;0.25;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;229;-763.5272,351.0518;Inherit;False;Property;MainSmoothness;Main Smoothness;21;0;Create;True;0;0;False;0;False;0;0.224124;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;240;-113.4765,613.3879;Inherit;False;Property;PaintSmoothness;Paint Smoothness;22;0;Create;True;0;0;False;0;False;0;0.1882353;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;-2307.802,486.9239;Inherit;True;Property;DamageNM;Damage NM;7;0;Create;True;0;0;False;0;False;-1;02045fcd06eb2d74397ad0dcb7450563;4ea5083d09e1aa747b5ad9a32ad2cb74;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;234;-366.0204,581.3159;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;226;-699.5082,261.8367;Inherit;False;89;MaskBAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;104;-1450.597,-1018.89;Inherit;True;Property;Texture4;Texture4;30;0;Create;True;0;0;False;0;False;-1;None;0b2ec52f502fe5943bc55689099e11b5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
